...
// DEPRECATED: This file is deprecated in favor of pkg/crypto/symmetric/
//
// Migration guide:
// - Use symmetric.NewNonceGenerator() + symmetric.Encrypt() instead of ChaCha20Cipher
// - Nonce size changed: 24 bytes (XChaCha20) → 12 bytes (ChaCha20)
// - Use structured API: symmetric.EncryptedFrame instead of raw bytes
//
// This file will be removed in Epic 6 (cleanup phase).
// See: pkg/crypto/symmetric/README.md

// ChaCha20Cipher handles encryption/decryption using ChaCha20-Poly1305
// DEPRECATED: Use pkg/crypto/symmetric instead
type ChaCha20Cipher struct {
	aead cipher.AEAD
}

// NewChaCha20Cipher creates a new ChaCha20-Poly1305 cipher with the given 32-byte key
// DEPRECATED: Use pkg/crypto/symmetric.NewNonceGenerator() + symmetric.Encrypt() instead
