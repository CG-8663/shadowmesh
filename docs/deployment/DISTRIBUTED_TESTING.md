<h1>
  ...
  Chronara Group ShadowMesh - Distributed Testing Guide
</h1>
...
6. Note the public IP address (e.g., `<YOUR_SERVER_IP>`)
...
```yaml
relay:
  url: "wss://<YOUR_SERVER_IP>:8443/ws"
  # ... rest of config
```
...
# 2025/11/01 18:05:01 Connecting to relay: wss://<YOUR_SERVER_IP>:8443/ws
