# AI Agent Prompt Instructions for ShadowMesh VPN Project

## Purpose
This document contains precise prompt instructions for AI agents (Claude, Gemini, etc.) to accurately build the ShadowMesh secure VPN network. Each section provides context, constraints, and expected outputs to ensure consistency and quality.
...
```
You are designing an AI agent for network optimization using Claude/Gemini API.
...
2. AI Processing:
   - Construct prompt for Claude/Gemini with metrics data
...
AI INTEGRATION:
- Feed logs and events to Claude/Gemini
