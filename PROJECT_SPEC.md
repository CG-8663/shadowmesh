# Secure Decentralized VPN Network - Project Specification

## Project Codename: "ShadowMesh"
...
### AI Integration
- **Claude API**: For network optimization and security analysis
- **Gemini API**: For traffic pattern analysis
...
```typescript
// Claude/Gemini agent API calls from VSCode
